...
class TestPublishResults:
    ...
    def test_sends_email_when_env_vars_present(
        self, mock_send_email, mock_input, mock_output, synthesizer_output
    ):
        mock_input.read_text.return_value = json.dumps(synthesizer_output)
        mock_output.write_text = MagicMock()
    ...
    def test_posts_linkedin_when_env_vars_present(
        self, mock_post_li, mock_input, mock_output, synthesizer_output
    ):
        mock_input.read_text.return_value = json.dumps(synthesizer_output)
        mock_output.write_text = MagicMock()
    ...
    @patch("agents.publisher_agent.INPUT_FILE")
    @patch("agents.publisher_agent.send_email")
    def test_email_failure_recorded_as_error(
        self, mock_send_email, mock_input, mock_output, synthesizer_output
    ):
        mock_input.read_text.return_value = json.dumps(synthesizer_output)
        mock_output.write_text = MagicMock()
    ...
    @patch("agents.publisher_agent.INPUT_FILE")
    @patch("agents.publisher_agent.post_to_linkedin")
    def test_linkedin_failure_recorded_as_error(
        self, mock_post_li, mock_input, mock_output, synthesizer_output
    ):
        mock_input.read_text.return_value = json.dumps(synthesizer_output)
        mock_output.write_text = MagicMock()
    ...
    @patch("agents.publisher_agent.OUTPUT_FILE")
    @patch("agents.publisher_agent.INPUT_FILE")
    def test_always_includes_linkedin_post_preview(
        self, mock_input, mock_output, synthesizer_output
    ):
        mock_input.read_text.return_value = json.dumps(synthesizer_output)
        mock_output.write_text = MagicMock()
